			...
			<div class="col-md-9 ftco-animate pb-5">
				<p class="breadcrumbs mb-2">
					<span class="mr-2"><a href="index.html">Mypetcare <i
							class="ion-ios-arrow-forward"></i></a></span> <span>펫시터 지원 <i
						class="ion-ios-arrow-forward"></i></span>
				</p>
				<h1 class="mb-0 bread">펫시터 지원</h1>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-6 text-center mb-5">
				<h2 class="heading-section">펫시터로 활동해보세요!</h2>
				<p>반려동물 돌보기! 나도 자신이 있다?</p>
				<p>사랑스런 반려동물들을 돌보며 수익을 벌어요</p>
				<button type="button" class="btn btn-primary"
					onClick="location.href='http://localhost:8090/mypetcare/support_write_petsitter'">펫시터
					지원 신청서</button>
			</div>
		</div>

		<section class="ftco-section">
			<h2 class="heading-section">펫시터는 어떻게 활동하게 되나요?</h2>
			<div class="container">
				<div class="row">
